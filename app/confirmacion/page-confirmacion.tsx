      ...
      <main className="confirm-main">
        ...
        {state === 'approved' && (
          <div className="confirm-card anim-scale-in delay-2">
            ...
            <div className="receipt" style={{ marginBottom: '1.4rem' }}>
              ...
              {txId && (
                <div className="receipt-row">
                  ...
                  <span className="value" style={{ fontFamily: 'monospace', fontSize: '0.7rem' }}>
                    {txId}
                  </span>
                </div>
              )}
              ...
              <div className="receipt-row total">
                ...
                <span className="value">
                  {amount ? `$${(amount / 100).toFixed(2)}` : pkgData?.precioLabel ?? 'Pagado'}
                </span>
              </div>
            </div>
            ...
            <p className="confirm-note">Recibirás un correo de confirmación después de agendar.</p>
          </div>
        )}
        ...
        {state === 'error' && (
          <div className="confirm-error">
            ...
            <a
              href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL}?subject=Verificación de Pago&body=ID: ${txId ?? 'desconocido'}`}
