      ...
      <main className="schedule-main">
        ...
        <div className="schedule-header anim-fade-down delay-2">
          ...
          <h1 className="schedule-title">
            Agenda tu <em>primera sesión</em>
          </h1>
          <p className="schedule-subtitle">
            Elige una fecha y hora abajo. Tu consejero se reunirá
            contigo en línea a la hora indicada.
          </p>
          {pkgData && (
            <div className="schedule-pill">
              ✓ &nbsp; Pago confirmado · {pkgData.sesiones} sesiones listas para agendar
            </div>
          )}
        </div>
          ...
          {calendlyReady ? (
            <>
              <div
                ...
                data-url={`${calendly.url}?hide_gdpr_banner=1&primary_color=9b6dd4`}
              />
              <Script
            ...
            <div className="calendly-placeholder">
              ...
              <p>
                Configura <code>NEXT_PUBLIC_CALENDLY_URL</code> en Cloudflare Pages
                para activar el calendario.
              </p>
              <div className="placeholder-code">
                NEXT_PUBLIC_CALENDLY_URL=https://calendly.com/tu-enlace
              </div>
            </div>
          )}
        </div>
...
export default function AgendarPage() {
  const pkgData = null // Nav has no pkg context at page level — fine
  return (
    <>
      <Nav />
      <Suspense
